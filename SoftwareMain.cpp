...
void MainWndAddWidgets(HWND hWnd) {
	...
	hStaticControl = CreateWindowA("static", "Welcome to DKAudioTeka! \n (Прежде чем вводить название песни, нажмите кнопку Clear)", WS_VISIBLE | WS_CHILD | ES_CENTER, 200, 5, 280, 48, hWnd, NULL, NULL, NULL);
...
void SetOpenFileParams(HWND hWnd) {
	...
	ofn.nMaxFileTitle = 0;
	ofn.lpstrInitialDir = "G:/Данила/С++/Курсач/output.txt";
